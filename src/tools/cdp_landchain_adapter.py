...
class CDPLangChainToolAdapter(BaseTool[BaseModel, Any]):
    ...
    def __init__(self, langchain_tool: LangChainTool):
        ...
        if hasattr(self._langchain_tool, "_run") and callable(self._langchain_tool._run):  # type: ignore
            self._callable: Callable[..., Any] = self._langchain_tool._run  # type: ignore
        elif hasattr(self._langchain_tool, "func") and callable(self._langchain_tool.func):  # type: ignore
